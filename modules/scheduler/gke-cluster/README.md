...
| <a name="input_auto_monitoring_scope"></a> [auto\_monitoring\_scope](#input\_auto\_monitoring\_scope) | Scope of auto monitoring for Managed Prometheus. e.g., 'ALL', 'KUBERNETES\_CONTROL\_PLANE', etc. Defaults to 'NONE'. | `string` | `"NONE"` | no |
