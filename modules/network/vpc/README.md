...
| <a name="input_default_proxy_subnetwork_size"></a> [default\_proxy\_subnetwork\_size](#input\_default\_proxy\_subnetwork\_size) | The size, in CIDR bits, of the default proxy subnetwork. Used when var.proxy_subnetwork is true. | `number` | `23` | no |
